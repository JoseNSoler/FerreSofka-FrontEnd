            ...
            <Container >
                ...
                <Navbar.Collapse id="responsive-navbar-nav" className='perNavBar'>
                    <Nav className="me-auto">
                        ...
                        <Nav.Link href="/Front_FerreteriaSofka/entradaProducto">Entrada Inventario</Nav.Link>
                        <Nav.Link href="/Front_FerreteriaSofka/crearUsuario">Crear usuario</Nav.Link>
                    </Nav>
                    <Nav>
